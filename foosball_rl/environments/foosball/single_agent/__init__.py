...
from foosball_rl.environments.foosball.single_agent.episode_definition import FoosballEpisodeDefinition
...
gym.register(
    id=foosball_id,
    entry_point='foosball_rl.environments.foosball.single_agent.foosball:RawEnv',
