import os
from typing import Optional, Callable, Dict, Type, Union, Any
...
def make_vec_env(  # NOSONAR
    ...
    Removed setting render_mode, in order to use standard env properties
    ...
    def make_env(rank: int) -> Callable[[], gym.Env]:
        def _init() -> gym.Env:
            ...
            if isinstance(env_id, str):
                try:
                    env = gym.make(env_id)  # type: ignore[arg-type]
                except TypeError:
